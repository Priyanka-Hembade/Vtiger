...
public class VtigerListeners extends VtigerBaseClass implements ITestListener {
...
//		test.addScreenCaptureFromBase64String(from);
	...
	public void onStart(ITestContext context) {
		...
		spark = new ExtentSparkReporter("./src/main/resources/Organization.html");
		spark.config().setDocumentTitle("failure screenshot");
